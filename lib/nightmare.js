  ...
  if(parentfn) {
    if (typeof parentfn === 'function') {
      ...
      if (!~Nightmare.namespaces.indexOf(name)) {
        ...
        keys(parentfn).forEach(function (key) {
          Nightmare.prototype[name].parentfn[key] = parentfn[key];
        })
        parentfn = Nightmare.prototype[name].parentfn;
      }
      ...
      Nightmare.prototype[name].parentfn = parentfn;
    }
  }
